defmodule ControlFinancerServer.Records.RecordAccountBank do
  ...
  def changeset(record_account_bank, attrs) do
    record_account_bank
    |> cast(attrs, [:description, :category_id, :user_id, :account_bank_id, :value, :payment_date, :status])
    |> validate_required([:description, :user_id, :account_bank_id, :value, :payment_date])
  end
end
